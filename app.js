...
const SUPABASE_URL = "https://ztbxwovqtbprclbhajir.supabase.co"; // Supabase 项目地址
const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp0Ynh3b3ZxdGJwcmNsYmhhamlyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQxODMzNTcsImV4cCI6MjA5OTc1OTM1N30.xkGVgj6EePNLAuaRcYLVbZLUGFq4YU9kIL30GhrF2sU"; // anon public key（设计上可公开，靠数据库 RLS 规则保护）
...
function runSearch() {
  ...
  fetchFeed(false); // 语义零命中 → 回退实时 GitHub 搜索
}
